...
const properties = [
  {
    id: 1,
    title: 'Navya Greens',
    location: 'Waje, Panvel, Navi Mumbai, Maharashtra, India',
  ...
  return (
    <>
      ...
      >
        ...
        {/* Property Cards */}
        <div className="lg:absolute lg:left-[28vw] lg:top-[10vh] flex flex-col lg:flex-row gap-6 lg:gap-[2vw] px-4 lg:px-0">
          ...
          >
            ...
            <div className="lg:w-[38%] bg-reon-greenDark flex flex-col justify-between px-10 py-12 min-h-[44vh] lg:min-h-0">
              ...
              <div style={{ animation: 'slideUp 0.5s 0.35s both' }}>
                ...
                <button className="btn-accent w-full text-center py-4 text-sm tracking-wider">
